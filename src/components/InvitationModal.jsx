        ...
        >
          <div className="flex relative">
            <div className="w-1/2 hidden lg:inline">
              ...
              <h2 className="text-5xl font-bold tracking-normal text-customPrimary">
                Winter is coming
              </h2>
              ...
              <ul className="mb-6 text-white mt-12">
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Secure and Private Connectivity</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Connect Anywhere and Everywhere in South Africa</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Customized Access and Traffic Management</span>
                </li>
              </ul>
            </div>
            <div className="w-full lg:w-1/2 flex items-center flex-col justify-center pt-24 sm:pt-0">
              ...
              <h3 className="mb-7 text-2xl text-white font-bold leading-snug text-center">
                Join And Accelerate Your Success
              </h3>
